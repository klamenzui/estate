...
CREATE TABLE IF NOT EXISTS `expense` (
  ...
  `status` enum('pending', 'transferred') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payment` (
  ...
  `status` enum('pending', 'payed', 'transferred') NOT NULL DEFAULT 'pending',
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: transfer
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `src_table` varchar(200) NOT NULL,
  `from_src` int(11) NOT NULL,
  `to_card` int(11) NOT NULL,
  `amount` double NOT NULL,
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `description` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `utilityservice_invoice` (
  ...
  `status` enum('pending', 'payed', 'transferred') NOT NULL COMMENT 'Status complete = transfered',
  `period` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
VALUES
  (1, 1, 0, 'hryvnia', 0, 'Vitalis ua card');
INSERT INTO
  `card` (
    `id`,
    `user_id`,
...
INSERT INTO
  `share` (`id`, `estate_id`, `card_id`, `percentage`)
VALUES
  (1, 6, 1, 50);
INSERT INTO
  `share` (`id`, `estate_id`, `card_id`, `percentage`)
...
VALUES
  (
    ...
    'test',
    '',
    '$2a$10$.mVq/v/pttO.puqjNzLVcOjbJREKbMDy8SbWDGzXK2Ow3c5oBZeHG',
    '1',
    'male',
    'user/male-2.svg',
    ''
